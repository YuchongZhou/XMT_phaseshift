...
PID_P = FourCharTfloat(str(7),str(8),str(9),str(10));%通过译码将读取到的数据进行译码得到 实际的数据
PID_I = FourCharTfloat(str(11),str(12),str(13),str(14));%通过译码将读取到的数据进行译码得到 实际的数据
PID_D = FourCharTfloat(str(15),str(16),str(17),str(18));%通过译码将读取到的数据进行译码得到 实际的数据
pause(0.1);
