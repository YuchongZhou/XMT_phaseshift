 ...
 *
 * SIL generated interface for code: "sltestFuelRateControlExample"
 *
 */
...
/* interface data */
EngSensors i_sensors;

/* interface data */
real32_T o_fuel_rate;

/* interface data */
Fueling_ModeType o_o_Fueling_Mode;
...
XIL_INTERFACE_ERROR_CODE xilInitialize(uint32_T xilFcnId)
{
  ...
  {
    o_o_Fueling_Mode = Fueling_ModeType_None;
  }

  /* Single In-the-Loop Component */
  if (xilFcnId == 0) {
    sltestFuelRateContro_initialize(rt_errorStatus, &(RTModel), &(localDW));
    sltestFuelRateControlExam_Start(&(localDW));

    {
      output_2_cData_1_nonaddr_io = ( int32_T ) o_o_Fueling_Mode;
    }
  } else {
...
XIL_INTERFACE_ERROR_CODE xilSystemInitialize(uint32_T xilFcnId)
{
  ...
  /* Single In-the-Loop Component */
  if (xilFcnId == 0) {
    sltestFuelRateControlExamp_Init(&(o_o_Fueling_Mode), &(localDW));
   ...
   case XIL_OUTPUT_COMMAND:
    {
      ...
      if (!initComplete) {
        ...
        {
          void * dataAddress = (void *) &(i_sensors.throttle);
        ...
        {
          void * dataAddress = (void *) &(i_sensors.speed);
          xil_fcnid0_task1_output_u[tableIdx].memUnitLength = 1 * sizeof
            (real32_T);
          xil_fcnid0_task1_output_u[tableIdx++].address = (MemUnit_T *)
            dataAddress;
        ...
        {
          void * dataAddress = (void *) &(i_sensors.ego);
          xil_fcnid0_task1_output_u[tableIdx].memUnitLength = 1 * sizeof
            (real32_T);
          xil_fcnid0_task1_output_u[tableIdx++].address = (MemUnit_T *)
            dataAddress;
        ...
        {
          void * dataAddress = (void *) &(i_sensors.map);
          xil_fcnid0_task1_output_u[tableIdx].memUnitLength = 1 * sizeof
            (real32_T);
          xil_fcnid0_task1_output_u[tableIdx++].address = (MemUnit_T *)
            dataAddress;
...
XIL_INTERFACE_ERROR_CODE xilOutput(uint32_T xilFcnId, uint32_T xilTID)
{
  ...
  switch (xilTID) {
   case 1:
    ...
    sltestFuelRateControlExample(&(i_sensors), &(o_fuel_rate),
      &(o_o_Fueling_Mode), &(localDW));
...
XIL_INTERFACE_ERROR_CODE xilUpdate(uint32_T xilFcnId, uint32_T xilTID)
{
  ...
  switch (xilTID) {
   case 1:
    sltestFuelRateControlExa_Update(&(localDW));
    break;
   ...
   case XIL_INITIALIZE_COMMAND:
    {
      ...
      if (!initComplete) {
        ...
        {
          void * dataAddress = (void *) &(o_fuel_rate);
