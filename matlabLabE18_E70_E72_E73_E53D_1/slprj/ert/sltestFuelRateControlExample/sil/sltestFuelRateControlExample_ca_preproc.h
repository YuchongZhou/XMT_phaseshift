...
#ifndef SLTESTFUELRATECONTROLEXAMPLE_CA_PREPROC_H
#define SLTESTFUELRATECONTROLEXAMPLE_CA_PREPROC_H
...
#endif                                 /* SLTESTFUELRATECONTROLEXAMPLE_CA_PREPROC_H */
