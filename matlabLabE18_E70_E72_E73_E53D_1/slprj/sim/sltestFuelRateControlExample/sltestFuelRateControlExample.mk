...
MODEL                   = sltestFuelRateControlExample
MODULES                 = sltestFuelRateControlExample.c sltestFuelRateControlExample_capi.c 
...
NUMST                   = 1
NCSTATES                = 0
BUILDARGS               =  GENERATE_ASAP2=0 OPTS="-DSLMSG_ALLOW_SYSTEM_ALLOC"
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 0
ALLOCATIONFCN           = 0
...
MODELLIB                  = sltestFuelRateControlExamplelib.lib
MODELREF_LINK_LIBS        = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\slprj\sim\sltestFuelRateControlExample
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(MATLAB_ROOT)\toolbox\simulinktest\simulinktestdemos
...
LIBS = $(LIBS) $(MATLAB_ROOT)\extern\lib\win64\microsoft\libmwsl_log_load_blocks.lib
