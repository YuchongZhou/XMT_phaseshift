...
m_MoveOrVoltFlag=str(5); %电压或者位移
DATA_1 = FourCharTfloat(str(7),str(8),str(9),str(10));%通过译码将读取到的数据进行译码得到 实际的数据
DATA_2 = FourCharTfloat(str(11),str(12),str(13),str(14));%通过译码将读取到的数据进行译码得到 实际的数据
DATA_3 = FourCharTfloat(str(15),str(16),str(17),str(18));%通过译码将读取到的数据进行译码得到 实际的数据
pause(0.1);
